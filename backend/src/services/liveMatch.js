...
export const liveMatch = async (data) => {
    switch (data.event) {
        case "playerGoal":
            await addGoalToMatchStats(data.playerID, data.matchID, data.scoreUs, data.scoreOpp);
            break;
        case "oppGoal":
...
export const addGoalToMatchStats = async (playerID, matchID, scoreUs, scoreOpp) => {
