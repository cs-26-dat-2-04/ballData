...
export default function PopUpInputPlayer() {
  return (
    <>
        <Popup trigger={<button className="trigger-button">Tilføj spiller</button>} position="right center" modal nested>
        {close => (
          <div className="modal">
            <div className="header"> 
              ...
              &times;
                ...
                <form autoComplete="off" action={data => {
                    if (test(data))
                        close();
                }}>
                    <div className="content">                
                        ...
                        <div className="input-container">
                            ...
                            <div className="inputBox">
                                ...
                                <input type="text" name="name" pattern="[A-Za-zæøåÆØÅ]*" required/><a className="disclaimer"> *</a>
                            </div>
                            <label>Position: </label>
                            <div className="inputBox">
                                {/*no restrictions, just has to be filled*/}
                                <input type="text" name="position" required/><a className="disclaimer"> *</a>
                            </div>
